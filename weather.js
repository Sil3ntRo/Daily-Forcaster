...
function getWeather(){
	...
	if(city != ''){
		...
		$.ajax({
			url: 'http://api.openweathermap.org/data/2.5/weather?q=' + city + "&units=imperial" + "&APPID=dfc20fb3393b7759966b0b6c30c5264a",
			type: "GET",
			dataType: 'jsonp',
...
function showResults(data){
    ...
    "<h3 style='padding-left:40px;'><strong>Wind Speed</strong>: " +data.wind.speed+"mi/hr</h3>" +
